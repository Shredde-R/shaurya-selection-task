...
let no_of_registrations = 0;
no_of_registrations +=localStorage.getItem("registration-storage");
...
signUp.addEventListener('click',()=>{
    ...
    no_of_registrations++;
    //store
    localStorage.setItem("registration-storage",no_of_registrations);
    document.getElementById("output").innerHTML = localStorage.getItem("registration-storage");
});
document.getElementById("output").innerHTML = localStorage.getItem("registration-storage");
